...
class Game extends Component {
    ...
    moveOpponent = () => {
        const movePlayer = this.moveBoard(this.state.opponent, this.state.opponentDir);
        movePlayer ? this.setState({ opponent: movePlayer }):
    ...
    render() {
        ...
        const divider = [...Array(ROW_SIZE * 0.8)].map(_=> <div>{"."}</div>);
